...
class CustomerSearchScreen extends ConsumerStatefulWidget {
  static const routeName = '/customer_form';  // ← add this
  ...
  Widget _buildTransferButtons(CustomerModel c) {
    final items = [
      ...
      },
      {
        ...
        'route': PrintLabelScreen.routeName,  // use the constant here!
      },
    ];
        ...
        children: items.map((item) {
          ...
          return Tooltip(
            ...
            child: GestureDetector(
              onTap: () {
                if (route == PrintLabelScreen.routeName) {
                                  ...
                                  child: FittedBox(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        if (c.licensePhotoUrl?.isNotEmpty ??
                                            false) ...[
                                          const Text(
                                            'Licence',
                                            style: TextStyle(
